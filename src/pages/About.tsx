  ...
  return (
    ...
    <div className=" flex items-center gap-1 ml-32 py-4 text-white">
       ...
       <div className="relative w-full h-[500px] overflow-hidden mt-8">
          ...
          <h2 className=" w-[80%] text-white mt-4 ml-4 text-xl max-sm:opacity-0">The Club supports exists to provide access to cricket for all and we have created a family-orientated environment in which all players feel supported and valued as members.</h2>
          </div>
       ...
       <div className=" w-[70%] max-sm:w-full text-white">
          ...
          <span className=" font-normal text-lg max-sm:text-sm">Through our platform, we aim to cultivate a culture of resilience, determination, and sportsmanship, instilling the belief that with dedication and perseverance, anything is possible.</span>
        </div>
       </div>
       </div>
