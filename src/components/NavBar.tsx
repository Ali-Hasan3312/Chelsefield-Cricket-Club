...
const NavBar = () => {
  ...
  return (
    <div className="h-24 w-full bg-white flex items-center justify-between gap-8 px-4">
        ...
        <div>
            <div className="flex gap-10 text-black text-lg mr-4 font-semibold">
                ...
                <Link to={"/hall"}  className={`hover:text-blue-500 transition-all duration-300 text-nowrap ${location.pathname==="/hall"? " text-blue-500" : ""}`}>Hire Hall</Link>
            </div>
        </div>
       <div className="flex items-center gap-4">
       <Link to={"/join"} className="h-12 w-24 rounded-lg bg-white flex items-center justify-center font-semibold hover:bg-blue-500 text-blue-500 border border-blue-500 hover:text-white transition-all duration-300">Join</Link>
